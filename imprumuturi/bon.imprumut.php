...
<DIV STYLE = "WIDTH: 100%; MARGIN: 20px AUTO;">
    <DIV ID = "declarationINTRO" STYLE = "MARGIN: 0 AUTO; WIDTH: 100%; BACKGROUND-COLOR: WHITE;">
        <IMG SRC = "logo.jpg" STYLE = "WIDTH: 18vw; HEIGHT:4.5vw; MARGIN-TOP: 1.3vw; MARGIN-RIGHT: 1.3vw; MARGIN-BOTTOM: 1.3vw;">
       	<B><CENTER><FONT STYLE = "FONT-SIZE: 2.5vw">DECLARATIE IMPRUMUT MAGAZIE<BR></FONT>Seria: <?php echo $seria;?></CENTER><BR><BR><BR><LEFT><FONT STYLE = "FONT-SIZE: 1.5VW">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Se elibereaza catre <?php if($worker != '' && $worker != 'NUME ANGAJAT')echo $worker; else if($worker == 'NUME ANGAJAT') echo '<font style = "text-decoration: underline dotted;"><i>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspNUME ANGAJAT&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</i></font>';else echo '&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp';?> (marca: <?php if($marca != '' && $marca != 'NR. MARCA') echo $marca; else if($marca == 'NR. MARCA') echo '<font style = "text-decoration: underline dotted;"><i>'.$marca.'</i></font>'; else echo '&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp';?>), angajat al sectiei <?php if($sectia != '') echo $sectia; else echo '&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp'; ?>,  urmatoarele produse, cu titlu de imprumut, pe o perioada delimitata, incepand de azi, <?php echo date('d.m.Y h:i:s', time()).', pana la '.date('d.m.Y h:i:s', strtotime($endMaxDate));?>  :<BR><BR>
   	</DIV>
   	<DIV ID = "scrollableDIV" STYLE = "WIDTH: 99.5%; MAX-HEIGHT: 30vw; OVERFLOW: AUTO; PADDING: 0; BORDER: 2px SOLID BLACK;">
        <TABLE WIDTH = 100% STYLE = "TEXT-ALIGN: CENTER;">
            <TD>
                <TABLE ID = "bon.magazie.imprumut" WIDTH = 100% BORDER = 1 ALIGN = CENTER STYLE = "BORDER-COLLAPSE: SEPARATE; PADDING: 0; MARGIN: 0; BORDER-SPACING: 0;">
                    <THEAD BORDER = 1 STYLE = "POSITION: STICKY; TOP: 0; BACKGROUND-COLOR: LIGHTGREY;">
                        <TR BORDER = 1>
		                    ...
		                    <TH WIDTH = 5% HEIGHT = 20 ALIGN = CENTER FONT STYLE = "FONT-SIZE: 1.5VW;FONT-WEIGHT: BOLD; BORDER: 1px SOLID BLACK;">Stoc initial</TH>
		                    ...
		                    <TH WIDTH = 5% HEIGHT = 20 ALIGN = CENTER FONT STYLE = "FONT-SIZE: 1.5VW;FONT-WEIGHT: BOLD; BORDER: 1px SOLID BLACK;">Stoc final</TH>
		                    <TH WIDTH = 5% HEIGHT = 20 ALIGN = CENTER FONT STYLE = "FONT-SIZE: 1.5VW;FONT-WEIGHT: BOLD; BORDER: 1px SOLID BLACK;">Val. tot.</TH>
		                    <TH WIDTH = 10% HEIGHT = 20 ALIGN = CENTER FONT STYLE = "FONT-SIZE: 1.5VW;FONT-WEIGHT: BOLD; BORDER: 1px SOLID BLACK;">Data retur</TH>
		                    <TH WIDTH = 10% HEIGHT = 20 ALIGN = CENTER FONT STYLE = "FONT-SIZE: 1.5VW;FONT-WEIGHT: BOLD; BORDER: 1px SOLID BLACK;">Motiv imprumut</TH>
					...
					<?php 
					    if($action == 'Adauga') 
						{
							if($amount > 0) require $_SERVER['DOCUMENT_ROOT'].'/ramira/magazie/imprumuturi/declaratie.imprumut.php';
							else require $_SERVER['DOCUMENT_ROOT'].'/ramira/magazie/imprumuturi/read.declaratie.php';
						}
...
<SCRIPT>
    ...
    var table = document.getElementById('bon.magazie.imprumut'),rIndex;
    ...
    for(var i = 1; i < table.rows.length; i++)
    {
	    table.rows[i].onclick = function()
	    {
		    ...
		    window.parent.document.getElementById("productNameImprumut").value = this.cells[0].innerHTML;
		    window.parent.document.getElementById("productImprumut").value = this.cells[1].innerHTML;
		    window.parent.document.getElementById("furnizorImprumut").value = this.cells[2].innerHTML;
			window.parent.document.getElementById("stockImprumut").value = this.cells[4].innerHTML;
			window.parent.document.getElementById("amountImprumut").value = this.cells[5].innerHTML;
			var units = window.parent.document.getElementsByClassName("unitsImprumut");
			for(var i = 0; i < units.length; i++)
			{
			    if(this.cells[6].innerHTML != '') units[i].value = this.cells[6].innerHTML;
			    else units[i].value = 'N.A.';
			}
			window.parent.document.getElementById("dataDisplay").value = this.cells[9].innerHTML;
			window.parent.document.getElementById("dataDisplay").innerHTML = this.cells[9].innerHTML;
			window.parent.document.getElementById("motivImprumut").value = this.cells[10].innerHTML;
            window.parent.document.getElementById("dataEnd").onchange();
			if(new Date(window.parent.document.getElementById("dataDisplay").value) < new Date(window.parent.document.getElementById("dataStart").value))
			{
			...
			window.parent.document.getElementById("observatii").value = this.cells[11].innerHTML;
